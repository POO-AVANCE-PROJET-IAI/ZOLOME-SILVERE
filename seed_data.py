...
from zolome_medecins.models import Specialite, Medecin, AffecterSpecialite
from zolome_patients.models import Personne, Patient
from zolome_parametres.models import TypeActe, Medicament, Acte
