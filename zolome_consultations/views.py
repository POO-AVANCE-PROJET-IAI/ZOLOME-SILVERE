...
def consultation_list(request):
    ...
    return render(request, 'zolome_consultations/consultation_list.html', context)

@login_required
def consultation_detail(request, pk):
    consultation = get_object_or_404(Consultation, pk=pk)
    return render(request, 'zolome_consultations/consultation_detail.html', {'consultation': consultation})
...
def consultation_add(request):
    ...
    return render(request, 'zolome_consultations/consultation_form.html', {'form': form, 'mode': 'ajouter'})
...
def consultation_edit(request, pk):
    ...
    return render(request, 'zolome_consultations/consultation_form.html', 
...
def consultation_delete(request, pk):
    ...
    return render(request, 'zolome_consultations/consultation_confirm_delete.html', {'consultation': consultation})
