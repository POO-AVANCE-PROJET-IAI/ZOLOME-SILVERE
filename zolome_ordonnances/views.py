...
def ordonnance_list(request):
    ...
    return render(request, 'zolome_ordonnances/ordonnance_list.html', {'ordonnances': ordonnances})

@login_required
def ordonnance_detail(request, pk):
    ordonnance = get_object_or_404(Ordonnance, pk=pk)
    return render(request, 'zolome_ordonnances/ordonnance_detail.html', {'ordonnance': ordonnance})
...
def ordonnance_add(request, consultation_id=None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and formset.is_valid():
            with transaction.atomic():
                ...
                return redirect('zolome_ordonnances:ordonnance_detail', pk=ordonnance.pk)
        else:
    ...
    return render(request, 'zolome_ordonnances/ordonnance_form.html', context)
...
def ordonnance_delete(request, pk):
    ...
    return render(request, 'zolome_ordonnances/ordonnance_confirm_delete.html', {'ordonnance': ordonnance})
