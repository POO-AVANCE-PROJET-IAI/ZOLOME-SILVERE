...
def patient_list(request):
    ...
    return render(request, 'zolome_patients/patient_list.html', context)
...
def patient_add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            patient = form.save()
            return redirect('zolome_patients:patient_list')
    else:
        form = PatientFormComplet()
    return render(request, 'zolome_patients/patient_add.html', {'form': form})
...
def patient_edit(request, pk):
    ...
    return render(request, 'zolome_patients/patient_edit.html', {'form': form, 'patient': patient})
...
def patient_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('zolome_patients:patient_list')
    return render(request, 'zolome_patients/patient_delete.html', {'patient': patient})
...
def patient_detail(request, pk):
    patient = get_object_or_404(Patient, pk=pk)
    return render(request, 'zolome_patients/patient_detail.html', {'patient': patient})
