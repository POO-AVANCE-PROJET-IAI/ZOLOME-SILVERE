...
import uuid
from zolome_medecins.models import Specialite
...
class Acte(models.Model):
    ...
    specialite = models.ForeignKey('zolome_medecins.Specialite', on_delete=models.CASCADE, related_name='actes', null=True)
    consultation = models.ForeignKey('zolome_consultations.Consultation', on_delete=models.CASCADE, related_name='actes', null=True, blank=True)
