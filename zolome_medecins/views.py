...
def medecin_list(request):
    ...
    return render(request, 'zolome_medecins/medecin_list.html', {
...
def medecin_detail(request, pk):
    ...
    return render(request, 'zolome_medecins/medecin_detail.html', 
...
def medecin_add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('zolome_medecins:medecin_list')
    else:
        form = MedecinFormComplet()
    return render(request, 'zolome_medecins/medecin_form.html', {'form': form, 'mode': 'ajouter'})
...
def medecin_edit(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('zolome_medecins:medecin_detail', pk=medecin.pk)
    else:
    ...
    return render(request, 'zolome_medecins/medecin_form.html', {'form': form, 'mode': 'modifier', 'medecin': medecin})
...
def medecin_delete(request, pk):
    ...
    return render(request, 'zolome_medecins/medecin_confirm_delete.html', {'medecin': medecin})

# Vues pour les spécialités
@login_required
def specialite_list(request):
    specialites = Specialite.objects.all()
    return render(request, 'zolome_medecins/specialite_list.html', {'specialites': specialites})
...
def specialite_add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('zolome_medecins:specialite_list')
    else:
        form = SpecialiteForm()
    return render(request, 'zolome_medecins/specialite_form.html', {'form': form, 'mode': 'ajouter'})
...
def specialite_edit(request, pk):
    ...
    return render(request, 'zolome_medecins/specialite_form.html', {'form': form, 'mode': 'modifier', 'specialite': specialite})
...
def specialite_delete(request, pk):
    ...
    if request.method == 'POST':
        specialite.delete()
        return redirect('zolome_medecins:specialite_list')
    return render(request, 'zolome_medecins/specialite_confirm_delete.html', {'specialite': specialite})
