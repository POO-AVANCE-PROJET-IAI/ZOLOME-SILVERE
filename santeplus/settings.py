...
INSTALLED_APPS = [
    ...
    'zolome_utilisateurs.apps.zolomeUtilisateursConfig',
    'zolome_patients.apps.zolomePatientsConfig',
    'zolome_medecins.apps.zolomeMedecinsConfig',
    'zolome_consultations.apps.zolomeConsultationsConfig',
    'zolome_ordonnances.apps.zolomeOrdonnancesConfig',
    'zolome_factures.apps.zolomeFacturesConfig',
    'zolome_parametres.apps.zolomeParametresConfig',
...
# Authentication
AUTH_USER_MODEL = 'zolome_utilisateurs.Utilisateur'

LOGIN_REDIRECT_URL = 'zolome_utilisateurs:dashboard'
LOGOUT_REDIRECT_URL = 'zolome_utilisateurs:login'
LOGIN_URL = 'zolome_utilisateurs:login'
