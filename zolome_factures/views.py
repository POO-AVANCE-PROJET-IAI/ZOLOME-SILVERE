...
from zolome_patients.models import Patient
from zolome_parametres.models import Acte

@login_required
def facture_list(request):
    factures = Facture.objects.all().order_by('-date_enreg_facture')
    return render(request, 'zolome_factures/facture_list.html', {'factures': factures})
...
def facture_detail(request, pk):
    ...
    if request.method == 'POST' and 'paiement_submit' in request.POST:
        ...
        if paiement_form.is_valid():
            ...
            return redirect('zolome_factures:facture_detail', pk=facture.pk)
    else:
    ...
    return render(request, 'zolome_factures/facture_detail.html', context)
...
def facture_add(request, consultation_id=None):
    ...
    return render(request, 'zolome_factures/facture_form.html', context)
...
def facture_delete(request, pk):
    ...
    return render(request, 'zolome_factures/facture_confirm_delete.html', {'facture': facture})
...
def select_patient_for_facture(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('zolome_factures:select_consultation', patient_id=patient.pk)
    else:
        form = PatientSelectionForm()
    
    return render(request, 'zolome_factures/select_patient.html', {'form': form})
...
def select_consultation(request, patient_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('zolome_factures:facture_preview', consultation_id=consultation.pk)
    else:
    ...
    return render(request, 'zolome_factures/select_consultation.html', {
        'form': form,
        'patient': patient
    })
...
def facture_preview(request, consultation_id):
    ...
    return render(request, 'zolome_factures/facture_preview.html', {
        'form': form,
        'consultation': consultation,
        'actes': actes,
...
def facture_pdf(request, pk):
    ...
    template = get_template('zolome_factures/facture_pdf.html')
