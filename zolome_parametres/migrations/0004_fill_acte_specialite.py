...
def fill_acte_specialite(apps, schema_editor):
    ...
    """
    Acte = apps.get_model('zolome_parametres', 'Acte')
    Specialite = apps.get_model('zolome_medecins', 'Specialite')
    AffecterSpecialite = apps.get_model('zolome_medecins', 'AffecterSpecialite')
...
class Migration(migrations.Migration):
    dependencies = [
        ('zolome_parametres', '0003_remove_typeacte_specialites_acte_specialite'),
    ]
