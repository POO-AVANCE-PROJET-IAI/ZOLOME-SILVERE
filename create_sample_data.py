...
from zolome_parametres.models import Medicament, TypeActe, Acte
from zolome_patients.models import Patient, Personne
from zolome_medecins.models import Medecin, Specialite, AffecterSpecialite
from zolome_utilisateurs.models import Utilisateur
