...
from zolome_consultations.models import Consultation
...
def medicament_list(request):
    ...
    return render(request, 'zolome_parametres/medicament_list.html', context)
...
def medicament_add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('zolome_parametres:medicament_list')
    else:
        form = MedicamentForm()
    
    return render(request, 'zolome_parametres/medicament_form.html', {'form': form, 'title': 'Ajouter un médicament'})
...
def medicament_edit(request, pk):
    ...
    return render(request, 'zolome_parametres/medicament_form.html', {'form': form, 'title': 'Modifier un médicament'})
...
def medicament_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('zolome_parametres:medicament_list')
    return render(request, 'zolome_parametres/medicament_confirm_delete.html', {'medicament': medicament})
...
def type_acte_list(request):
    ...
    return render(request, 'zolome_parametres/type_acte_list.html', context)
...
def type_acte_add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('zolome_parametres:type_acte_list')
    else:
        form = TypeActeForm()
    
    return render(request, 'zolome_parametres/type_acte_form.html', {'form': form, 'title': 'Ajouter un type d\'acte'})
...
def type_acte_edit(request, pk):
    ...
    return render(request, 'zolome_parametres/type_acte_form.html', {'form': form, 'title': 'Modifier un type d\'acte'})
...
def type_acte_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('zolome_parametres:type_acte_list')
    return render(request, 'zolome_parametres/type_acte_confirm_delete.html', {'type_acte': type_acte})
...
def acte_list(request):
    ...
    return render(request, 'zolome_parametres/acte_list.html', context)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if acte.consultation:
                return redirect('zolome_consultations:consultation_detail', pk=acte.consultation.pk)
            return redirect('zolome_parametres:acte_list')
    else:
        form = ActeForm(consultation_id=consultation_id)
    
    return render(request, 'zolome_parametres/acte_form.html', {'form': form, 'title': 'Ajouter un acte'})
...
def acte_affecter_consultation(request):
    ...
    if not consultation_id:
        ...
        return redirect('zolome_consultations:consultation_list')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('zolome_consultations:consultation_detail', pk=consultation_id)
    else:
        form = ActeConsultationForm(consultation_id=consultation_id)
    
    return render(request, 'zolome_parametres/acte_affecter_consultation.html', {
        'form': form, 
        'consultation': consultation,
...
def acte_edit(request, pk):
    ...
    return render(request, 'zolome_parametres/acte_form.html', {'form': form, 'title': 'Modifier un acte'})
...
def acte_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        if consultation:
            return redirect('zolome_consultations:consultation_detail', pk=consultation.pk)
        return redirect('zolome_parametres:acte_list')
    
    return render(request, 'zolome_parametres/acte_confirm_delete.html', {'acte': acte})
